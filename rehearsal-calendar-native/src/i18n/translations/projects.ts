...
export const es = {
  projects: {
    ...
    shareInviteMessage: (projectName: string) => `Únete al proyecto "${projectName}" en la app Rehearsal:`,
...
export const de = {
  projects: {
    ...
    shareInviteMessage: (projectName: string) => `Tritt dem Projekt „${projectName}" in der Rehearsal-App bei:`,
