...
export const ru = {
  projects: {
    ...
    createToUsePlanner: 'Здесь будет видно, кто и когда свободен. Для этого нужен проект с участниками.',
    admin: 'Админ',
...
export const en = {
  projects: {
    ...
    createToUsePlanner: 'This is where you see who is free and when. It needs a project with people in it.',
    admin: 'Admin',
...
export const es = {
  projects: {
    ...
    createToUsePlanner: 'Aquí se ve quién está libre y cuándo. Hace falta un proyecto con gente.',
    admin: 'Admin',
...
export const de = {
  projects: {
    ...
    createToUsePlanner: 'Hier siehst du, wer wann frei ist. Dafür braucht es ein Projekt mit Leuten.',
    admin: 'Admin',
