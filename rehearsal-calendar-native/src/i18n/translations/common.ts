...
export const es = {
  ...
  betaBanner: {
    ...
    bugReportPlaceholder: 'Describe el problema...',
    bugReportSent: '¡Gracias! Informe enviado',
    send: 'Enviar',
  },
  days: {
    monday: 'Lunes',
...
export const de = {
  ...
  betaBanner: {
    ...
    bugReportPlaceholder: 'Problem beschreiben...',
    bugReportSent: 'Danke! Bericht gesendet',
    send: 'Senden',
  },
  days: {
    monday: 'Montag',
