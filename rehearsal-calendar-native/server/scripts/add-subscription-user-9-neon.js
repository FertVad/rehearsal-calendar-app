#!/usr/bin/env node
/**
 * Script: Add test subscription to user ID 9 in PostgreSQL (Neon)
 * Usage: node scripts/add-subscription-user-9-neon.js
 */
...
async function addTestSubscription() {
  ...
  try {
    ...
    console.log(`\n🎉 User ID ${userId} now has Premium access with payment history in PostgreSQL!`);
