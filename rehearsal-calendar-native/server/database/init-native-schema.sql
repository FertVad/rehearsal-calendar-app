...
-- Includes migration 007 for the documented schema-then-baseline workflow.
...
-- Includes migration 008 for the documented schema-then-baseline workflow.
...
-- Includes migration 009 for the documented schema-then-baseline workflow.
